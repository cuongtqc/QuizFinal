...
@section('body')
	...
	<div id="LoginTab" ng-controller="LoginForm" class="container-fluid wow fadeInDown">
		...
		<div class="row" ng-show="<?php echo isset($_SESSION['userName'])?>">
			...
			<button ng-click="Profile()" type="button" class="btn btn-lg btn-login col-lg-1 col-md-2 col-sm-3 col-xs-3">Profile</button>
	...
	<div id="leaderboard" ng-controller="Leaderboard" class="container-fluid wow slideInLeft">
		...
		<div ng-repeat="user in userList|orderBy:'-userScore'|limitTo:5" class="leaderboard-user">
			<p class="col-lg-2 col-md-2 col-sm-3 col-xs-3"> @{{user.username}} </p>
			<p class="col-lg-1 col-md-1 col-sm-1 col-xs-2 col-lg-offset-9 col-md-offset-9 col-sm-offset-8 col-xs-offset-7"> @{{user.userScore}} </p>
		</div>
	</div>
