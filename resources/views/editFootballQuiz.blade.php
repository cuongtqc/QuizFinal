...
<html>
    <head>
		...
		<script src="../../public/Se2015/Se2015-firebase-master/js/football/editQuiz.js"> </script>
    </head>
	
    <body ng-app="Quiz" class="container-fluid">
		
		<div ng-controller="UpdateFootball" class="container-fluid wow fadeInLeft" id="questionBoard">
			...
			<p class="input-answer center-block leaderboard-tittle"> Football </p>
