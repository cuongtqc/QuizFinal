...
<html>
    <head>
		...
		<script src="../../public/Se2015/Se2015-firebase-master/js/japan/editQuiz.js"> </script>
    </head>
	
    <body ng-app="Quiz" class="container-fluid">
		
		<div ng-controller="UpdateJapan" class="container-fluid wow fadeInLeft" id="questionBoard">
			...
			<p class="input-answer center-block leaderboard-tittle"> Japan </p>
