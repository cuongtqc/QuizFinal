...
<html>
    <head>
		...
		<script src="js/IQ/editQuiz.js"> </script>
    </head>
	
    <body ng-app="Quiz" class="container-fluid">
		
		<div ng-controller="UpdateIQ" class="container-fluid wow fadeInLeft" id="questionBoard">
			...
			<p class="input-answer center-block leaderboard-tittle"> IQ </p>
